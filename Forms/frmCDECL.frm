...
'**********************************************************************************
'** Demonstrate how to call CDECL dll functions using the cCallFunc class.
'**********************************************************************************
...
Private Sub Form_Load()
  ...
  Set p = New cCallFunc                                     'Create cCallFunc class instance
  ...
  r = p.CallFunc(sDLL, "time", 0)                           'Get the time (in secs) for use as a random number seed
  r = p.CallFunc(sDLL, "srand", r)                          'Seed the random number generator
  
  sBuf = String$(20, vbNullChar)                            'Make some space
  sFmt = "%6d" & vbNullChar                                 'The format...
  
  For i = 1 To ELEMENTS
    r = p.CallFunc(sDLL, "swprintf", StrPtr(sBuf), StrPtr(sFmt), i)
...
Private Sub Form_Unload(Cancel As Integer)
  Set p = Nothing                                           'Destroy the cCallFunc class
End Sub
...
'the wrapper function instead of the .bas function
  ...
  QueryPerformanceCounter qpC1
    p.CallFunc sDLL, "qsort", VarPtr(arInt(1)), ELEMENTS, 2, nCallbackAddr
